	...
	<div class="container-fluid">
		<nav class="row">
			<nav class="navbar navbar-expand-sm navbar-dark bg-light col">
				<!-- brand -->
				<a href="admin/home" class="navbar-brand w w-auto-sm"> <svg width="32" height="32" viewBox="0 0 512 512"
					...
					<div class="flex scrollable hover">
						<div class="nav-border b-primary" data-nav>
							<ul class="nav bg">
								...
								<li><a href="home" class="nav-text" name="home"><span class="nav-icon"><i data-feather="home"></i></span>Thư Viện</a></li>
								<li><a href="admin/video" class="nav-text" name="adminvideo"><span class="nav-icon"><i
											data-feather="film"></i></span>Khám phá</a></li>
								<li><a href="admin/users" class="nav-text" name="adminuser"><span class="nav-icon"><i
											data-feather="user"></i></span>Người dùng</a></li>
								<li><a href="admin/reports" class="nav-text" name="adminreport"><span class="nav-icon"><i
											data-feather="flag"></i></span>Report Management</a></li>
								<div class="dropdown-divider"></div>
								<li><a href="logout" class="nav-text"><span class="nav-icon"><i data-feather="log-out"></i></span>Logout</a></li>
							</ul>
						</div>
					</div>
				</div>
