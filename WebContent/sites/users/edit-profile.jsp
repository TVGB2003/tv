				...
				<div class="row">
					<div class="col-sm-6">
						<div class="md-form-group float-label">
							<input class="md-input" type="text" name="id" value="${user.id}" disabled> <label>Username</label>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="md-form-group float-label">
					...
					<div class="col-sm-6">
						<div class="md-form-group float-label">
							<input class="md-input" type="password" name="password" required> <label>Password</label>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="md-form-group float-label">
