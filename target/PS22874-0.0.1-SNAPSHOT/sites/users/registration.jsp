					...
					<form action="" method="post" role="form">
						<div class="col-sm-12">
							<div class="md-form-group float-label">
								<input class="md-input" type="text" name="username" value="${user.id}"> <label>Username</label>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="md-form-group float-label">
						...
						<div class="col-sm-12">
							<div class="md-form-group float-label">
								<input class="md-input" type="password" name="password" value="${user.password}"> <label>Password</label>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="md-form-group float-label">
								<input class="md-input" type="text" name="email" value="${user.email}"> <label>Email</label>
							</div>
						</div>
						<jsp:include page="/common/inform.jsp"></jsp:include>
						<button type="submit" class="btn btn-primary mb-4" name="signup">Signup</button>
						<div>
